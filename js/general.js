...
var map = {
	"./faq_controller.js": "./src/js/controllers/faq_controller.js",
	"./gallery_controller.js": "./src/js/controllers/gallery_controller.js",
	"./list_controller.js": "./src/js/controllers/list_controller.js",
	...
	"./promo_controller.js": "./src/js/controllers/promo_controller.js",
...
/***/ "./src/js/controllers/faq_controller.js":
/*!**********************************************!*\
  !*** ./src/js/controllers/faq_controller.js ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./src/js/controllers/gallery_controller.js":
/*!**************************************************!*\
  !*** ./src/js/controllers/gallery_controller.js ***!
  \**************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "init",
    value: function init() {
      var galleryThumbs = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](this.bottomTarget, {
        spaceBetween: 10,
        slidesPerView: 4,
        freeMode: true,
      ...
      var galleryTop = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](this.topTarget, {
        spaceBetween: 10,
        navigation: {
...
_defineProperty(_default, "targets", ["top", "bottom", "prev", "next"]);



/***/ }),

/***/ "./src/js/controllers/list_controller.js":
/*!***********************************************!*\
  !*** ./src/js/controllers/list_controller.js ***!
  \***********************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function init() {
      ...
      this.sliderTargets.forEach(function (item) {
        var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](item, {
          slidesPerView: 1,
          spaceBetween: 30,
          navigation: {
            nextEl: _this.nextTarget,
            prevEl: _this.prevTarget
          },
          breakpoints: {
            640: {
              slidesPerView: 2,
...
_defineProperty(_default, "targets", ["prev", "next", "slider"]);
  ...
  _createClass(_default, [{
    ...
    value: function subMenu() {
      this.itemTargets.forEach(function (item) {
        var target = item.querySelector(".menu__arrow");
        var menu = item.querySelector(".menu__sub-list");
...
/***/ "./src/js/controllers/promo_controller.js":
/*!************************************************!*\
  !*** ./src/js/controllers/promo_controller.js ***!
  \************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "init",
    value: function init() {
      var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](this.sliderTarget, {
        slidesPerView: 1,
        spaceBetween: 30,
        navigation: {
          nextEl: this.nextTarget,
...
var phones = document.querySelectorAll(".js-mask");
var phoneOption = {
  mask: '+{7} (000) 000-00-00'
}; // Инициализация маски для телефона

phones.forEach(function (item) {
  return Object(imask__WEBPACK_IMPORTED_MODULE_4__["default"])(item, phoneOption);
});
...
var searchHandlers = document.querySelectorAll(".js-search");
var search = document.querySelector(".search");
var searchClose = search.querySelector(".search__close");
searchHandlers.forEach(function (item) {
